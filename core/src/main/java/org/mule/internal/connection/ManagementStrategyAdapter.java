...
/**
 * Base class for {@link ManagementStrategy} implementations which contains state
 ...
 * @since 4.0
 */
public abstract class ManagementStrategyAdapter<Config, Connection> implements ManagementStrategy<Connection>, Closeable
{
     ...
     */
    ManagementStrategyAdapter(Config config, ConnectionProvider<Config, Connection> connectionProvider, MuleContext muleContext)
    {
        this.config = config;
