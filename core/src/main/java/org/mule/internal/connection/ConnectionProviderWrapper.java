...
public abstract class ConnectionProviderWrapper<Config, Connection> implements ConnectionProvider<Config, Connection>
{
    ...
    @Override
    public ManagementStrategy<Connection> getManagementStrategy(ManagementStrategyFactory managementStrategyFactory)
    {
        return delegate.getManagementStrategy(managementStrategyFactory);
    }
