...
public class PooledManagedConnectionTestCase extends AbstractMuleTestCase
{
    ...
    private PooledManagedConnection<Object> managedConnection;

    @Before
    public void before()
    {
        managedConnection = new PooledManagedConnection<>(connection, pool);
    }
