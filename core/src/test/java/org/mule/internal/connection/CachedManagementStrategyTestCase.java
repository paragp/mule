...
public class CachedManagementStrategyTestCase extends AbstractMuleTestCase
{
    ...
    private CachedManagementStrategy<Apple, Banana> connectionStrategy;

    @Before
    public void before() throws Exception
    {
        when(connectionProvider.connect(config)).thenReturn(connection);
        connectionStrategy = new CachedManagementStrategy<>(config, connectionProvider, muleContext);
    }

    @Test
    public void getConnection() throws Exception
    {
        ManagedConnection<Banana> managedConnection = connectionStrategy.getManagedConnection();
    ...
    {
        connectionStrategy.getManagedConnection().getConnection();
