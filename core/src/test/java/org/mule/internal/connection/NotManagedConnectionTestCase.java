...
public class NotManagedConnectionTestCase extends AbstractMuleTestCase
{
    ...
    private ManagedConnectionAdapter<Banana> managedConnection;

    @Before
    public void before()
    {
        managedConnection = new NotManagedConnection<>(connection, connectionProvider);
    }
