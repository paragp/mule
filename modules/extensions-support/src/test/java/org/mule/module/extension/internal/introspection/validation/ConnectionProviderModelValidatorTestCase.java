...
public class ConnectionProviderModelValidatorTestCase extends AbstractMuleTestCase
{
    ...
    public static class TestConnectionProvider implements ConnectionProvider<Config, ValidatorTestConnection>
    {
        ...
        @Override
        public ManagementStrategy<ValidatorTestConnection> getManagementStrategy(ManagementStrategyFactory managementStrategyFactory)
        {
    ...
    public static class InvalidTypeConnectionProvider implements ConnectionProvider<Config, Apple>
    {
        ...
        @Override
        public ManagementStrategy<Apple> getManagementStrategy(ManagementStrategyFactory managementStrategyFactory)
        {
            return managementStrategyFactory.cached();
        }
    }
